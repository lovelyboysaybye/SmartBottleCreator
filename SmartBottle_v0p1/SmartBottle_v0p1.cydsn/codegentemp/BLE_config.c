...
cy_stc_ble_gapp_disc_param_t cy_ble_discoveryParam[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        {0x35u, 0x81u, 0x21u, 0x50u, 0xA0u, 0x00u}, /* uint8_t* direct_addr */ 
...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x05u, 0x0Du, 0x09u, 0x53u, 0x6Du,
        0x61u, 0x72u, 0x74u, 0x20u, 0x42u, 0x6Fu, 0x74u,
        0x74u, 0x6Cu, 0x65u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x2Du] = {
    /* Device Name */
    (uint8_t)'S', (uint8_t)'m', (uint8_t)'a', (uint8_t)'r', (uint8_t)'t', (uint8_t)' ', (uint8_t)'B', (uint8_t)'o',
(uint8_t)'t', (uint8_t)'t', (uint8_t)'l', (uint8_t)'e', 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Au] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[26] }, /* CapSense Proximity */
    { 0x0002u, (void *)&cy_ble_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0012u, (void *)&cy_ble_attValues[27] }, /* Characteristic User Description */
};
...
cy_stc_ble_gap_bd_addr_t cy_ble_deviceAddress = {{0x35u, 0x81u, 0x21u, 0x50u, 0xA0u, 0x00u}, 0x00u };
